...
/**
 * We need a new component called Feature which looks like this when no featuredResult 
 ...
 * </main>
 * 
 * The different facts look like this: title, dated, images.map, primaryimageurl, description, 
 * culture, style, technique, medium, dimensions, people, department, division, contact, creditline
 * 
 * The <Searchable /> ones are: culture, technique, medium (first toLowerCase it), 
